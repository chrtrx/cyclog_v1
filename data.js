...
export const SERVICE_TYPES = [
  ...
  { typeId:'cassette',    title:'Kassette tauschen',    icon:'⚙️', interval:8000, cat:'Antrieb' },
  { typeId:'brake-pads',  title:'Bremsbeläge tauschen', icon:'🛑', interval:3000, cat:'Bremsen' },
  { typeId:'rotors',      title:'Bremsscheiben prüfen', icon:'💿', interval:5000, cat:'Bremsen' },
  { typeId:'tyre-f',      title:'Reifen vorne',         icon:'🔵', interval:3000, cat:'Reifen' },
  { typeId:'tyre-r',      title:'Reifen hinten',        icon:'🔴', interval:2500, cat:'Reifen' },
