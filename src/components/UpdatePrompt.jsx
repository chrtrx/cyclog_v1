  ...
  return (
    <div className="upd-banner" onClick={() => updateServiceWorker(true)}>
      ...
      <style>{`
        ...
        .upd-txt { flex: 1; font-family: var(--sans); font-size: 0.875rem; font-weight: 800; letter-spacing: .3px; color: var(--ink1); }
        .upd-btn { flex-shrink: 0; background: var(--acc); color: var(--on-acc); border: none; border-radius: 8px; padding: 8px 14px; font-family: var(--mono); font-size: 0.75rem; font-weight: 700; letter-spacing: .5px; text-transform: uppercase; }
      `}</style>
    </div>
  )
}
