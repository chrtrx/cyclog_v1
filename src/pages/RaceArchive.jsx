  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .rtab { flex:1; padding:12px 8px; font-family:var(--mono); font-size:0.6875rem; font-weight:700; letter-spacing:1px; text-transform:uppercase; color:var(--ink3); background:none; border:none; border-right:1px solid var(--line); transition:background .15s,color .15s; display:flex; align-items:center; justify-content:center; gap:6px; }
        ...
        .rtab-badge { background:var(--crit); color:white; border-radius:50%; width:16px; height:16px; font-size:0.5625rem; display:flex; align-items:center; justify-content:center; font-weight:900; flex-shrink:0; }
        ...
        .race-cand-tag { font-family:var(--mono); font-size:0.65625rem; font-weight:800; letter-spacing:.5px; text-transform:uppercase; color:var(--acc); }
        .race-cand-name { font-family:var(--sans); font-size:0.9375rem; font-weight:800; color:var(--ink1); letter-spacing:.3px; margin-bottom:4px; }
        .race-cand-meta { display:flex; gap:12px; font-family:var(--mono); font-size:0.6875rem; color:var(--ink3); margin-bottom:10px; }
        .race-cand-actions { display:flex; gap:8px; }
        .race-cand-fill { flex:1; padding:11px; background:var(--acc); color: var(--on-acc); font-family:var(--sans); font-size:0.75rem; font-weight:800; letter-spacing:.5px; text-transform:uppercase; }
        .race-cand-dismiss { padding:11px 14px; background:none; border:1px solid var(--line); color:var(--ink3); font-family:var(--mono); font-size:0.6875rem; font-weight:700; letter-spacing:.5px; text-transform:uppercase; }
        ...
        .race-name { font-family:var(--sans); font-size:1rem; font-weight:800; color:var(--ink1); letter-spacing:.5px; }
        .race-place { background:color-mix(in srgb, var(--warn) 15%, transparent); color:var(--warn); font-family:var(--mono); font-weight:900; font-size:0.75rem; padding:3px 10px; border:1px solid color-mix(in srgb, var(--warn) 35%, transparent); white-space:nowrap; }
        .race-meta { display:flex; gap:12px; font-family:var(--mono); font-size:0.6875rem; color:var(--ink3); margin-bottom:8px; }
        .race-stats { display:flex; gap:6px; flex-wrap:wrap; margin-bottom:8px; }
        .rstat { background:color-mix(in srgb, var(--acc) 8%, transparent); color:var(--acc); border:1px solid color-mix(in srgb, var(--acc) 25%, transparent); padding:4px 10px; font-family:var(--mono); font-size:0.6875rem; font-weight:700; }
        .race-setup { font-family:var(--mono); font-size:0.6875rem; color:var(--ink2); padding-top:8px; border-top:1px solid var(--line); }
        .race-learn { font-family:var(--mono); font-size:0.6875rem; color:var(--ink2); margin-top:6px; line-height:1.5; }
        .race-cond { font-family:var(--mono); font-size:0.6875rem; color:var(--ink3); margin-top:4px; }

        .pack-empty-state { display:flex; flex-direction:column; align-items:center; padding:40px 20px; text-align:center; }
        .pack-empty-ico { font-size:2.5rem; margin-bottom:12px; }
        .pack-empty-title { font-family:var(--sans); font-size:1.125rem; font-weight:900; color:var(--ink1); letter-spacing:1px; text-transform:uppercase; margin-bottom:6px; }
        .pack-empty-sub { font-family:var(--mono); font-size:0.75rem; color:var(--ink3); margin-bottom:20px; }
        .pack-tpl-btn { background:color-mix(in srgb, var(--acc) 10%, transparent); border:1px solid color-mix(in srgb, var(--acc) 35%, transparent); color:var(--acc); font-family:var(--mono); font-size:0.75rem; font-weight:700; letter-spacing:1px; text-transform:uppercase; padding:12px 24px; }
        ...
        .pp-lbl { font-family:var(--mono); font-size:0.625rem; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:var(--ink3); }
        .pp-val { font-family:var(--sans); font-size:1.125rem; font-weight:900; color:var(--ink1); }
        ...
        .pp-crit { font-family:var(--mono); font-size:0.65625rem; color:var(--crit); font-weight:700; margin-top:7px; }

        .pack-actions { display:flex; gap:8px; margin-bottom:14px; }
        .pa-btn { flex:1; padding:10px 12px; background:var(--panel2); border:1px solid var(--line); font-family:var(--mono); font-size:0.6875rem; font-weight:700; letter-spacing:1px; text-transform:uppercase; color:var(--ink2); }
        ...
        .pc-ico { font-size:0.8125rem; width:18px; text-align:center; }
        .pc-lbl { flex:1; font-family:var(--mono); font-size:0.625rem; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:var(--ink2); }
        .pc-count { font-family:var(--mono); font-size:0.625rem; font-weight:700; color:var(--ink3); }
        ...
        .pi-name { font-family:var(--sans); font-size:0.875rem; font-weight:700; color:var(--ink1); }
        .pi-crit-tag { font-family:var(--mono); font-size:0.5625rem; font-weight:900; background:color-mix(in srgb, var(--crit) 15%, transparent); color:var(--crit); border:1px solid color-mix(in srgb, var(--crit) 35%, transparent); padding:1px 5px; letter-spacing:.5px; flex-shrink:0; }
        .ra-toast { position:fixed; bottom:140px; left:50%; transform:translateX(-50%); background:var(--panel); border:1px solid var(--acc); color:var(--ink1); padding:11px 22px; font-family:var(--mono); font-weight:500; font-size:0.8125rem; letter-spacing:.5px; z-index:1000; white-space:nowrap; }
      `}</style>
    </Page>
  )
}
...
function TemplateSheet({ loading, onClose, onSelect }) {
  return (
    <Sheet title="Vorlage laden" sub="Packliste aus Vorlage befüllen" onClose={onClose}>
      ...
      <style>{`
        .tpl-warn { font-family:var(--mono); font-size:0.6875rem; color:var(--ink3); background:var(--panel2); border:1px solid var(--line); padding:10px 12px; margin-bottom:14px; line-height:1.5; }
        .tpl-loading { text-align:center; font-family:var(--mono); font-size:0.8125rem; color:var(--ink3); padding:20px; }
        ...
        .tpl-name { flex:1; font-family:var(--sans); font-size:0.9375rem; font-weight:800; color:var(--ink1); letter-spacing:.5px; text-align:left; }
        .tpl-count { font-family:var(--mono); font-size:0.6875rem; color:var(--ink3); font-weight:700; }
      `}</style>
    </Sheet>
  )
}
...
function PackItemSheet({ user, item, onClose, onSaved }) {
  ...
  return (
    <Sheet title={item?.id ? 'Punkt bearbeiten' : 'Punkt hinzufügen'} sub="Packliste" onClose={onClose}>
      ...
      <style>{`
        .pi-err { font-family:var(--mono); font-size:0.6875rem; color:var(--crit); background:color-mix(in srgb, var(--crit) 7%, transparent); border:1px solid color-mix(in srgb, var(--crit) 30%, transparent); padding:10px 12px; margin-bottom:12px; line-height:1.5; }
        .pi-field { margin-bottom:14px; }
        .pi-lbl { display:block; font-family:var(--mono); font-size:0.6875rem; font-weight:700; letter-spacing:1px; text-transform:uppercase; color:var(--ink3); margin-bottom:6px; }
        .pi-sel { width:100%; background:var(--panel2); border:1px solid var(--line); padding:12px 14px; font-family:var(--mono); font-size:0.8125rem; font-weight:700; color:var(--ink1); outline:none; }
        ...
        .pi-crit-label { font-family:var(--mono); font-size:0.8125rem; font-weight:700; color:var(--ink1); }
      `}</style>
    </Sheet>
  )
}
  ...
  return (
    <Sheet title="Neues Rennen" sub={prefill ? 'Aus Strava-Aktivität vorausgefüllt – bitte ergänzen' : 'Setup und Ergebnis festhalten'} onClose={onClose}>
      ...
      <style>{`
        ...
        .ar-lbl { display:block; font-family:var(--mono); font-size:0.6875rem; font-weight:700; letter-spacing:1px; text-transform:uppercase; color:var(--ink3); margin-bottom:6px; }
        .ar-sel { width:100%; background:var(--panel2); border:1px solid var(--line); padding:12px 14px; font-family:var(--mono); font-size:0.8125rem; font-weight:700; color:var(--ink1); outline:none; }
        .ar-g2 { display:grid; grid-template-columns:1fr 1fr; gap:10px; }
        .ar-feel { display:flex; gap:6px; }
        .ar-feel-opt { flex:1; padding:11px 4px; background:var(--panel2); border:1px solid var(--line); font-family:var(--sans); font-size:0.75rem; font-weight:700; color:var(--ink2); }
        .ar-feel-opt.on { background:color-mix(in srgb, var(--acc) 12%, transparent); border-color:var(--acc); color:var(--acc); }
        .ar-area { width:100%; min-height:84px; background:var(--panel2); border:1px solid var(--line); padding:12px 14px; font-family:var(--mono); font-size:0.8125rem; color:var(--ink1); outline:none; resize:vertical; }
      `}</style>
    </Sheet>
  )
}
